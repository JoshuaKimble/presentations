...
description: "How we structure state and logic in React components across the monorepo."
---
...
> The sibling → app-level → monorepo scoping below is the same pattern we apply to all shared code in this repo. A separate doc covers that convention in full.
