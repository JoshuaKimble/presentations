...
2. [The Rule](#the-rule)
3. [Naming](#naming)
4. [File Location & Scope](#file-location--scope)
5. [Props Across the Server → Client Boundary](#props-across-the-server--client-boundary)
6. [Avoid Speculative Extraction](#avoid-speculative-extraction)
7. [Example](#example)
